    ...
    <div className='landing-view-container'>
      ...
      <FeatureContainer image={<ProjectsSVG />} invert>
        <div className='feature-copy-container'>
          <h2>Projects</h2>
          <p>
            Our projects are as diverse as our members. From open source initiatives to personal experiments, we’ve got it all.
          </p>
        </div>
      ...
      <FeatureContainer image={olLandingImg(ResourcesImg)}>
        <div className='feature-copy-container'>
          <h2>Resources</h2>
          <p>
            We take pride in sharing knowledge and resources within the community. At oneleif, there are countless members to
            learn from and mentor.
          </p>
        </div>
